...
public class PanelSelectWorkMode extends JPanel {
...
//  JToggleButton bVar = new JToggleButton();
  ...
  private void jbInit() throws Exception {
    ...
    this.setLayout(null);
    //rbCalib.setActionCommand("calib");
    //rbCalib.setSelected(true);
    //rbCalib.setText("калибровка приборов");
    //rbCalib.setBounds(new Rectangle(55, 33, 176, 25));

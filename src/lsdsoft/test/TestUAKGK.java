...
public class TestUAKGK
    ...
    protected static ImageIcon createImageIcon( String path ) {
        java.net.URL imgURL = TestUAKGK.class.getResource( path );
        if ( imgURL != null ) {
    ...
    public TestUAKGK() {
        cunit = (UAKGKCheckUnit)DataFactory.createCheckUnit(UAKSI2CheckUnit.class.getName());
    ...
    public static void main( String[] args ) {
        TestUAKGK testUAKGK = new TestUAKGK();
        testUAKGK.setVisible( true );
    }
    private void rotateGear() {
        if(gearStage == 0 ) {
            imgGear.setImage( iconGear1.getImage() );
            gearStage = 1;
        } else {
            imgGear.setImage( iconGear2.getImage() );
            gearStage = 0;
        }
        imgGear.repaint();
    }
    ...
    private void jbInit() throws Exception {
        ...
        jLabel3.setBounds(new Rectangle(32, 81, 62, 16) );
        jLabel4.setBounds(new Rectangle(252, 81, 62, 16) );
        ...
        jLabel6.setText( "Датчик Z" );
        jLabel6.setBounds(new Rectangle(472, 80, 62, 16) );
        ...
        tGotoX.setText( "0" );
        tGotoX.setBounds( new Rectangle( 44, 28, 68, 19 ) );
        jLabel5.setText( "X:" );
        ...
        tGotoY.setBounds(new Rectangle(44, 67, 68, 19) );
        tGotoY.setText( "0" );
        bGotoY.setText( "Go!" );
        ...
        jLabel7.setText( "Y:" );
        tGotoZ.setBounds(new Rectangle(44, 105, 68, 19) );
        tGotoZ.setText( "0" );
        bGotoZ.setText( "Go!" );
        ...
        jLabel8.setBounds(new Rectangle(11, 105, 25, 15) );
        jLabel8.setText( "Z:" );
        ...
        bFindMarker2.setText( "Поиск маркера" );
        ...
        imgButSX.setBounds(new Rectangle(100, 80, 16, 16));
        imgButSY.setBounds(new Rectangle(320, 80, 16, 16));
        imgButSZ.setBounds(new Rectangle(540, 80, 16, 16));
...
//    }
    ...
    void bGotoX_actionPerformed( ActionEvent e ) {
        try {
            cunit.goToLocation( Integer.parseInt( tGotoX.getText() ) );
        } catch ( Exception ex ) {
            System.err.println( ex.getMessage() );
        }
    }
